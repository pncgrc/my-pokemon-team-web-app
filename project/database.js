...
exports.DBConnect = exports.UpdatePokemon = exports.GetPokemonTeamAbilities = exports.GetAbilityOnPokemonByName = exports.GetAbilityFromAbilitiesDatabaseByName = exports.GetPokemonByName = exports.GetAbilities = exports.GetPokemon = exports.RegisterUser = exports.Login = exports.client = exports.MONGODB_URI = void 0;
const mongodb_1 = require("mongodb");
const dotenv_1 = __importDefault(require("dotenv"));
const bcrypt_1 = __importDefault(require("bcrypt"));
dotenv_1.default.config();
exports.MONGODB_URI = (_a = process.env.MONGO_URI) !== null && _a !== void 0 ? _a : "mongodb+srv://s080037:bRW1UPhSbMMGfqF2@project-webdev.od9yc1q.mongodb.net/?retryWrites=true&w=majority&appName=Project-Webdev";
exports.client = new mongodb_1.MongoClient(exports.MONGODB_URI);
/*** COLLECTION USERS ***/
const userCollection = exports.client.db("login-express").collection("users");
const saltRounds = 10;
...
const pokemonCollection = exports.client.db("poketeam").collection("pokemon");
const abilitiesCollection = exports.client.db("poketeam").collection("abilities");
